<?php
/********************************
Juda sodda va tushunarli file manager(o'zbekcha qilib aytganda shell)
Asosiy vazifasi file yuklash o'chirish yuklab olish papka ochish
Bu @iCoderNet tomonidan tarqatildi
********************************/
...
//Xavfsizlik uchun 
$allow_delete = true; // File o'chirishga ruhsat berish
$allow_upload = true; // File yuklashga ruhsat berish
$allow_create_folder = true; // Papka ochishga ruhsat berish
$allow_direct_link = true; // To'gridan-To'g'ri link bilan yuklab olishga ruhsat berish
$allow_show_folders = true; // Yashirin fayllarni ko'rsatmaslikka ruhsat berish

//Kodga tushunmayotgan bo'lsangiz iltimos kodni o'zgartirmang
$disallowed_patterns = ['*.php'];  
$hidden_patterns = ['*.php','.*']; 

$PASSWORD = '';  // Bu yerga parol qo'yishingiz mumkin parol qo'ysangiz har kirganingizda parol so'raydi
